...
<div class="container-fluid mt-5">
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{ route('qrcode.index') }}">QR Code</a></li>
        ...
        <div class="col-md-6 col-lg-4 mb-4">
            <div class="card card-custom h-100">
                ...
                <div class="card-body d-flex flex-column justify-content-between">
                    ...
                    <a href="{{ route('qrcode.generate', $course->id) }}" class="btn btn-purple mt-auto">Tampilkan QR Code</a>
                </div>
            </div>
        </div>
        @empty
